...
namespace CustomControls.RJControls
{
    public class CSDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = _3.PL.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = _3.PL.Properties.Resources.calendarDark;
                else calendarIcon = _3.PL.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
